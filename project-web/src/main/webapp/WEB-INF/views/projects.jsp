...
<body>
	...
	<div class="form-group">
		<span id="deleteSpan">
			<input type="hidden" id="projectSel" class="populate placeholder" style="width:300px">
			<button type="button" class="btn btn-default" data-toggle="modal" data-target="#taskDetails" onclick="clearSelTask();">Create Task</button>
		</span>
	</div>
